...
\usepackage[hidelinks,pdfauthor={},pdftitle={The Cost of a Decisive Revision: Evidence, Reuse, and Self-Application},pdfsubject={Decision cost, evidence reuse, and self-applicable revision},pdfkeywords={reflexive revision, decision trees, evidence budgets, evidence reuse, behavioural equivalence}]{hyperref}
...
% Reproducible anonymous PDF metadata with the documented pdfLaTeX build.
\pdfinfoomitdate=1
\pdftrailerid{}
\pdfsuppressptexinfo=-1
\begin{document}
\begin{center}
{\Large\bfseries The Cost of a Decisive Revision:}\par
\vspace{4pt}
{\normalsize\bfseries Evidence, Reuse, and Self-Application}
\end{center}
\vspace{-3pt}
\begin{abstract}
